...
namespace CpbTiming.SmsTiming
{
      ...
      IDisposable
    {
        ...
        private PropertyChangedEventHandler _PropertyChangedUI;
        ...
        void notifierUI_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            PropertyChangedEventHandler handler = _PropertyChangedUI;
